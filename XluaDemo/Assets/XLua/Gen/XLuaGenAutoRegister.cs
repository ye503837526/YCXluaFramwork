...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit1(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(GameFramwork.XlueDemoHotTest), GameFramworkXlueDemoHotTestWrap.__Register);
            ...
            translator.DelayWrapLoader(typeof(GameFramwork.NetEvnentCtrl), GameFramworkNetEvnentCtrlWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(GameFramwork.GameMapManager), GameFramworkGameMapManagerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(GameFramwork.HttpManager), GameFramworkHttpManagerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(GameFramwork.TimerManager), GameFramworkTimerManagerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(GameFramwork.LuaBehaviour), GameFramworkLuaBehaviourWrap.__Register);
